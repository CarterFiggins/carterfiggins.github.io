  ...
  return (
    <div className="content-body about-me-body">
      <div className="content-body__text fade-in-from-top">
        ...
        <p>
          With the wisdom of the Jedi Council, I harness the power of <b>React, GraphQL, Ruby On Rails, Vue, ORM tools, PostgreSQL, and Git.</b> The force flows through these tools, guiding me in my web development quests! 🔮💫
        </p>
        {/* <p>
